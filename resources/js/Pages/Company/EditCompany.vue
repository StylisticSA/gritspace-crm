...
const form = useForm({
    company_name: props.companies.company_name,
    vat_no: props.companies.vat_no,
    reg_no: props.companies.reg_no,
    address: props.companies.address,
    email: props.companies.email,
    phone: props.companies.phone,
});

const submit = () => {
    form.put(route('admin.company.update', props.companies.id), {
        onSuccess: () => {
            message.value = '';
...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="text-xl font-semibold leading-tight text-gray-800">Edit Companies</h2>
        </template>
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-4xl p-6 mx-auto space-y-6">
                    <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <h3 class="inline-block py-2 text-2xl font-medium text-black">Edit Company</h3>
