...
const submit = () => {
    form.post(route('admin.banking.store'), {
        onSuccess: () => {
            message.value = 'Banking Details have been Successfully.';
...
<template>
    <Head title="Add Banking Details" />
            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="max-w-4xl p-6 mx-auto space-y-6">
                    <div class="flex flex-col gap-3 mb-4 sm:flex-row sm:items-center sm:justify-between">
                        <h3 class="inline-block py-2 text-2xl font-medium text-black">Add banking Details</h3>
