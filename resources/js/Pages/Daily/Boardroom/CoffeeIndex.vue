...
const deleteamenity = () => {
    if (amenityToDelete.value) {
        router.delete(route('admin.coffee.destroy', amenityToDelete.value), {
            preserveScroll: true,
            onSuccess: () => {
                        ...
                        <table class="min-w-full border border-gray-300 divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ cofe.user_id }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-800">{{ cofe.coffee }}</td>
